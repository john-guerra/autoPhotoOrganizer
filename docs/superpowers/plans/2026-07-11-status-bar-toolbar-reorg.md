...
**Placeholder scan:** No TBD/TODO; every code step shows full code; version numbers say "use the actual current value" because the live `package.json` value must be read at execution (not a placeholder for *what* to do). ✓
